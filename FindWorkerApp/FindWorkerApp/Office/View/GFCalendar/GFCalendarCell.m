...
- (UILabel *)todayLabel {
    if (_todayLabel == nil) {
        ...
        _todayLabel.font = [UIFont boldSystemFontOfSize:12.0];
...
-(UIView*)signView
{
    if (!_signView) {
        ...
        _signView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 6, 6)];
        _signView.backgroundColor = [UIColor orangeColor];
        _signView.center = CGPointMake(self.bounds.size.width/2, self.bounds.size.height/2+12);
