...
@interface SWPublishFinishedView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SWPublishFinishedView
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.dataSource.count > 0) {
        ...
        myPublishDetailController.is_ending = YES;
