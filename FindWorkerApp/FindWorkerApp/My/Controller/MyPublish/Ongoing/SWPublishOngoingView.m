...
@interface SWPublishOngoingView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation SWPublishOngoingView
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (self.dataSource.count > 0) {
        ...
        SWPublishOngoingDetailController *detailController = [[SWPublishOngoingDetailController alloc] init];
        detailController.iid = taskData.iid;
        detailController.titleStr = taskData.title;
