...
@interface SWMySendController ()<UITableViewDataSource,UITableViewDelegate>
{
    NSInteger page;
}
...
@implementation SWMySendController
...
- (void)loadData {
    ...
    [[NetworkSingletion sharedManager]sendContractList:@{@"identity":@(1),@"type":@(1),@"p":@(page),@"each":@(15)} onSucceed:^(NSDictionary *dict) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    NotBeginCell *cell = (NotBeginCell*)[tableView  dequeueReusableCellWithIdentifier:@"NotBeginCell"];
    if (!cell) {
        cell = [[NotBeginCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"NotBeginCell"];
    }
