...
@interface SWMyReceiveController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger page;
}
...
@implementation SWMyReceiveController
...
- (void)loadData {
    ...
    [[NetworkSingletion sharedManager]sendContractList:@{@"identity":@(1),@"type":@(2),@"p":@(page),@"each":@(15)} onSucceed:^(NSDictionary *dict) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    OnGoingContractCell *cell = (OnGoingContractCell*)[tableView  dequeueReusableCellWithIdentifier:@"OnGoingContractCell"];
    if (!cell) {
        cell = [[OnGoingContractCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"OnGoingContractCell"];
    }
