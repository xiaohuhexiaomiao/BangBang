//
//  FinishiedConstructionViewController.m
//  FindWorkerApp
//
...
@interface FinishiedConstructionViewController ()<UITableViewDelegate,UITableViewDataSource>
{
    NSInteger page;
}
...
@implementation FinishiedConstructionViewController
